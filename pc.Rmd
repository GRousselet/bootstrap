---
title: "Percentage correct example"
...
- Condition 1 = `r round(mean(norm_samp), digits=1)`

- Condition 2 = `r round(mean(skew_samp), digits=1)`

- Condition 3 = `r round(mean(skew_samp2), digits=1)`  
