---
title: "Compare two dependent groups using hierarchical bootstrap sampling"
...
p
```
## Illustrate results (new version)
...
H = hierarchical confidence interval
NH = non-hierarchical confidence interval
...
The distributions of the bootstrap medians are very irregular. Bootstrapping at two levels (trials and participants) leads to much smoother distributions and different confidence intervals.
