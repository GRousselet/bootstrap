...
### Figure: width 
Use median width to look at typical confidence interval.
...
p.width.m <- p
```
The coverage issue identified for the t-test and the percentile bootstrap seem to some extent due to too short CIs. 
