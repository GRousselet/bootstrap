...
- Mean = `r round(mean(pop1), digits=2)`

- Variance = `r round(var(pop1), digits=2)`

Lognormal population:

- Mean = `r round(mean(pop2), digits=2)`

- Variance = `r round(var(pop2), digits=2)`
...
Each of these samples is like an experiment. For each experiment, we compute a statistics of interest, here the 20% trimmed mean. In each plot, the vertical dashed line marks the population 20% trimmed mean that we are trying to estimate.
...
In each plot, the vertical dashed line marks the population 20% trimmed mean, whereas the vertical continuous line marks the sample 20% trimmed mean.  
