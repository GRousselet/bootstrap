...
The Tukey *g-and-h* distributions have a median of zero. The parameter g controls the asymmetry of the distribution, while the parameter h controls the thickness of the tails. With h=0, g=0 corresponds to a normal distribution, whereas g=1 gives a distribution with the same shape as a lognormal distribution. These distributions are described in this 1985 book:
...
```{r, fig.width=7, fig.height=3, units = "cm", warning=FALSE}
